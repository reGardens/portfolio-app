      ...
      <html lang="en">
        ...
        <body className={`${inter.className} bg-white dark:bg-darkColor500`}>
          <div className="max-w-screen-2xl mx-auto !overflow-x-hidden">
            ...
            {/* notif maintenance */}
            <div className="fixed w-full z-10 left-0 flex items-center justify-center p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 mt-[4.5rem]" role="alert">
