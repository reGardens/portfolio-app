    ...
    return (
        <main className="grid md:grid-cols-2 min-h-screen flex-col items-center justify-between p-4 md:p-24 mt-20 md:mt-0">
            <article className='grid gap-4 order-2 md:order-1'>
                <p className='text-2xl font-bold dark:text-white hidden md:block'>Hi, I&apos;m Reza Bagus Pratama</p>
                <p className='text-2xl font-bold dark:text-white block md:hidden'>Hi, <br /> I&apos;m Reza Bagus Pratama</p>
            ...
            <div className='relative order-1 md:order-2'>
                ...
                <div className="w-full md:absolute -top-[29rem] -right-[8rem] hidden md:block">
                    <img src="/static/images/avatar-dekstop.png" alt="User" className='mx-auto w-[42rem]' />
                </div>
