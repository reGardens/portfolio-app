...
export default function Home() {
    return (
        <>
            <main className=" min-h-screen h-screen p-4 md:p-24">
                <article className='grid md:grid-cols-2 flex-col h-full items-center justify-between mt-20 md:mt-0'>
                    <HomeTitle />
                ...
                <section>
                    <p className="text-5xl font-extrabold text-darkColor500 dark:text-white">About me</p>
                </section>
            </main>
        </>
    )
