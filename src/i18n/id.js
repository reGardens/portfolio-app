const id = {
    ...
    alert: {
        ...
        maintenanceSubtitle: "Website ini sedang dalam pemeliharaan. Kami mohon maaf atas ketidaknyamanannya.",
    },

    // Header
    header: {
        greeting: "Hai, Saya Reza Bagus Pratama",
        role: "Pengembang Web Front-End",
        description: "Sebagai pengembang web, saya juga seorang competitive programmer dan penggemar teknologi.",
        emailLabel: "Tanyakan apa yang ingin kamu ketahui 😊",
        resume: "Resume",
    },
    ...
    about: {
        title: "Tentang saya",
        paragraph1: "Nama saya Reza Bagus Pratama. Saya berusia 29 tahun dan berasal dari Indonesia, tepatnya Jawa Tengah. Saya bekerja sebagai pengembang web frontend di industri IT. Saya telah melakukan pekerjaan freelance dan remote selama 4 tahun terakhir, serta mengerjakan proyek on-site (WFO).",
    ...
    error: {
        ...
        description: "Kami mohon maaf atas ketidaknyamanannya.",
        tryAgain: "Coba lagi",
    },
